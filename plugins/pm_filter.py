...
async def language_check(bot, query):
    ...
    if files:
        ...
        btn.insert(0, [
            InlineKeyboardButton("✅ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ✅", url="https://t.me/Moviesbank_Corporation/101")
        ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('💰EARN MONEY WITH BOT💸', url=CHNL_LNK) https://t.me/Moviesbank_Corporation/102
                  ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Prince0_66")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
